...
class InstallCommand extends Command
{
    ...
    protected function installFrontend(): void
    {
        ...
        $this->components->task("Installing and configuring Tailwind and Vite", function () use ($generateTSConfig) {
            $this->copyIfNotExistOrOverwrite(__DIR__ . '/../../stubs/craftable-pro.tailwind.config.js', base_path('craftable-pro.tailwind.config.js'));
            $this->copyIfNotExistOrOverwrite(__DIR__ . '/../../stubs/craftable-pro.vite.config.js', base_path('craftable-pro.vite.config.js'));
