          ...
          >
            <li v-for="file in data.data" :key="file.id" class="relative">
              <button
                ...
                :class="[
                  (selectedImage?.id === file.id && hasFocus) && 'ring-primary-500 ring-2 ring-offset-2',
                  hasFocus && 'focus-within:ring-primary-500 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100',
                  'group block w-full overflow-hidden rounded-md border border-gray-100 focus:outline-none',
                ]"
                @focus="hasFocus = true"
                @blur="hasFocus = false"
                tabindex="0"
              >
                <FileThumbnail :file="file" />
                  ...
                  <span class="sr-only focus:outline-none">
                    {{
              ...
              <template #tableRow="{ item, action }: any">
                ...
                >
                  <FileThumbnail
                    ...
                    :class="[
                      (selectedImage?.id === item.id && hasFocus) && 'ring-primary-500 ring-2 ring-offset-2',
                      hasFocus && 'focus-within:ring-primary-500 focus-within:ring-2 focus-within:ring-offset-2 focus-within:ring-offset-gray-100',
...
const selectFile = (file) => {
  if(selectedImage.value === file && hasFocus.value) {
    selectedImage.value = null;
