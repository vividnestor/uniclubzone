...
<body>
    <div class="bg-hero-image bg-cover">
        <div class=" w-full absolute bg-slate-50">
             <!-- navbar user profile -->
             <div class=" h-16 w-full flex items-center justify-between bg-white fixed">
                 <!-- left -->
                 <div class=" flex justify-start items-center">
                     <!-- burger icon -->
                     <div id="btnopen" class=" h-16 w-16 flex items-center justify-center text-2xl cursor-pointer">☰</div>
                     <!-- logo -->
                     <div class="px-3">
                 ...
                 <!-- right -->
                 <div class=" h-16 w-1/5 flex items-center justify-center">
                     <h1>profile</h1>
                    </div>
             </div>
             <hr class="w-full mt-16">
             <!-- containner club -->
             @yield('containner_user')
         </div>
         <div id="sidebar" class=" flex fixed top-0 left-0 h-screen w-full text-white transition-transform duration-300 ease-in-out transform -translate-x-full">
             ...
             <div id="btnclose" class=" w-4/5 bg-black  bg-opacity-10 cursor-pointer p-2">
                 <button class="w-12 h-12 bg-slate-400 hover:bg-slate-300 rounded-2xl text-2xl text-white">x</button>
             </div>
        </div>
    </div>
</body>
