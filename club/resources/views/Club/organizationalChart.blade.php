...
<body>
                ...
                <div class="w-full flex items-center justify-around font-bold text-sm">
                    ...
                    <div class="relative inline-block text-left">
                        ...
                        <div class="absolute right-0 z-10 mt-2 w-56 p-3 origin-top-right rounded-2xl bg-slate-100 shadow-lg ring-black ring-opacity-5 focus:outline-none hidden" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1" id="ontion">
                            ...
                            <a href="{{ url('Club/organizationalChart') }}" class="block px-4 py-2 text-sm text-orange-700" role="menuitem" tabindex="-1" id="menu-item-1">Organizational Chart</a>
    ...
    <div class="w-11/12 m-auto h-auto">
        <div class="w-full text-center p-10 text-2xl font-bold text-orange-700">
            <h3>Organizational Chart</h3>
        </div>
        <div class="w-full bg-orange-50 h-96 rounded-2xl mb-36"></div>
    </div>
</body>
<script>
