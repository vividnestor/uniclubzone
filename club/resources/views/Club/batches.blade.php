        ...
        <div class="grid grid-cols-12 w-full gap-4">
            ...
            <div class=" col-span-6 px-10">
                <div class="w-full flex items-center justify-around font-bold text-sm">
                    ...
                    <div class="relative inline-block text-left">
                        <div>
                            <button type="button" class="inline-flex w-full justify-center gap-x-1.5 rounded-md bg-white px-3 py-2 text-1xl font-semibold text-orange-700 shadow-sm ring-inset ring-0 hover:bg-gray-50" id="menu-button1" aria-expanded="true" aria-haspopup="true">
                            Other Batches
                            <svg class="-mr-1 h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                <path fill-rule="evenodd" d="M5.23 7.21a.75.75 0 011.06.02L10 11.168l3.71-3.938a.75.75 0 111.08 1.04l-4.25 4.5a.75.75 0 01-1.08 0l-4.25-4.5a.75.75 0 01.02-1.06z" clip-rule="evenodd" />
                            </svg>
